...
def main():
    ...
    manifest={'schema_version':'1.0','daily_plan':'daily_plan.json','long_story':'long_story.json','viral_plan':'viral_plan.json','long_video_count':1,'short_count':4,'external_assistant':'disabled','production_ready':True}
    (RUN_DIR/'daily_manifest.json').write_text(json.dumps(manifest,ensure_ascii=False,indent=2)+'\n')
    print('DAILY_CONTENT_CONTRACT=PASS long=1 shorts=4 patent=7-15m viral=internal')
