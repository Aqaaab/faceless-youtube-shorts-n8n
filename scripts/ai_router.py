...
class AIRouter:
    ...
    def _record(self,p,status,tokens=0,error="",cooldown_seconds=None):
        ...
        defaults={"PASS":0,"PAID_REQUIRED":86400,"ACCESS_OR_QUOTA":86400,"AUTH":86400,"MODEL_NOT_FOUND":86400,"RATE_LIMIT":15,"TRANSIENT":8,"BAD_REQUEST":0,"UNKNOWN":5,"SCHEMA_INVALID":0}
        if cooldown_seconds is None: cooldown_seconds=defaults.get(status,5)
