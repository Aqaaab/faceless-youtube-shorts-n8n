...
def main():
 ...
 for marker in ('idea_judged.json','long_story.json','daily-production-v2-plan-','preflight:','ENABLE_FREELLMAPI_PROVIDER','ENABLE_OLLAMA_PROVIDER','ENABLE_OPENROUTER_PROVIDER','ENABLE_CLOUDFLAREWORKERSAI_PROVIDER'):
