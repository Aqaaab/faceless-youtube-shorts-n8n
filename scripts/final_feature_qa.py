...
def main() -> int:
    ...
    if long_form:
        ...
        if not SHORT_MIN_SECONDS <= d <= SHORT_MAX_SECONDS: raise SystemExit(f'FINAL_FEATURE_QA_FAIL: Shorts duration {d:.2f}s outside {SHORT_MIN_SECONDS:g}-{SHORT_MAX_SECONDS:g}s')
        expected=(1080,1920)
