...
def normalize(d):
 ...
 for i,s in enumerate(sc,1):
  ...
  q=tokens(s.get('pexels_query',''));q=[x for x in q if x not in GENERIC_QUERY]
...
def main():
 ...
 print(f'Growth generation completed: dynamic scenes={len(d["scenes"])} + hook + pacing + visual plan + Arabic QA schema')
