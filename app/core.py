...
def generate_story(topic:str)->Story:
    system='''You are the production Story Engine for a premium Arabic automotive infographic channel. Return JSON only. Create one coherent factual story for the requested car/topic with EXACTLY 25 scenes and no filler. Every scene has id, Arabic narration, visual_intent, layout, callouts and duration. Narration is 25-75 Arabic words and directly drives the visual. Use only these layouts: hero, technical, spec, comparison, diagram, timeline. Use at least 4 layouts, at least 12 scenes with useful callouts, and at least 20 distinct visual intents. Total duration must be 420-900 seconds. CRITICAL Shorts contract: scene pairs (1,2), (7,8), (13,14), (19,20) are four independent Shorts and EACH pair must total 28-59 seconds. Prefer 14-24 seconds per scene for those eight scenes. Make visual_intent concrete: identify the vehicle system, camera/composition, infographic element, and on-screen information that should appear. Do not mention external media libraries or stock sources. The final visual language is a full-frame premium automotive editorial infographic, not an overlay placed on unrelated footage. Return strong title (20-100 chars), description (120+ chars), and 5+ useful tags.'''
