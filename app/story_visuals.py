...
def _visual_family(kind,scene_id):
    mapping={"performance":"performance","design":"design_detail","interior":"interior","technology":"technology","efficiency":"battery","safety":"safety","price":"wide_scene","hero":"front_3q"}
    return mapping.get(kind,"front_3q")
