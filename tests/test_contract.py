...
def strong_story() -> dict:
    ...
    for sid in range(1, 26):
        ...
        scenes.append({"id": sid, "narration": narration, "visual_intent": f"لقطة سيارة للمشهد {sid} مع تركيب بصري وتفصيل واضح للمعلومة الأساسية", "layout": layouts[(sid - 1) % len(layouts)], "callouts": callouts, "duration": 17.0})
    return {
        ...
        "short_titles": ["لماذا يلفت تصميم هذه السيارة الانتباه؟", "ما الذي يميز أداء السيارة في الاستخدام اليومي؟", "التقنية التي تجعل تجربة القيادة أكثر وضوحاً", "هل تجمع السيارة بين الأداء والتصميم بشكل متوازن؟"],
